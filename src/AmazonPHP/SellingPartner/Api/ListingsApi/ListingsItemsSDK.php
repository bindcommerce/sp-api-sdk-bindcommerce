...
final class ListingsItemsSDK implements ListingsItemsSDKInterface
{
     ...
     * @param string|null $sort_by  An attribute by which to sort the returned listing items. (optional, default to 'lastUpdatedDate')
     * @param string|null $sort_order  The order in which to sort the result items. (optional, default to 'DESC')
     * @param int|null $page_size  The number of results that you want to include on each page. (optional, default to 10)
