...
final class VendorShipmentsSDK implements VendorShipmentsSDKInterface
{
     ...
     * @param \DateTimeInterface|null $estimated_delivery_after  Get Shipment Details by passing Estimated Delivery Date After. Must be in &lt;a href&#x3D;&#39;https://developer-docs.amazon.com/sp-api/docs/iso-8601&#39;&gt;ISO 8601&lt;/a&gt; format. (optional)
     ...
     * @param \DateTimeInterface|null $label_created_after  Shipment labels created after this time will be included in the result. This field must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) datetime format. (optional)
     * @param \DateTimeInterface|null $label_created_before  Shipment labels created before this time will be included in the result. This field must be in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) datetime format. (optional)
     * @param string|null $buyer_reference_number  Get Shipment labels by passing buyer reference number. (optional)
     * @param string|null $vendor_shipment_identifier  Get Shipment labels by passing vendor shipment identifier. (optional)
     ...
     */
    public function getShipmentLabels(AccessToken $accessToken, string $region, $limit = null, $sort_order = null, $next_token = null, $label_created_after = null, $label_created_before = null, $buyer_reference_number = null, $vendor_shipment_identifier = null, $seller_warehouse_code = null)
    {
