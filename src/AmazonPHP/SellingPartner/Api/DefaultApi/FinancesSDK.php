...
final class FinancesSDK implements FinancesSDKInterface
{
     ...
     *
     * @param int|null $max_results_per_page  The maximum number of results per page. If the response exceeds the maximum number of transactions or 10 MB, the response is &#x60;InvalidInput&#x60;. (optional, default to 10)
     ...
     */
    public function listFinancialEventGroupsRequest(AccessToken $accessToken, string $region, $max_results_per_page = 10, $financial_event_group_started_before = null, $financial_event_group_started_after = null, $next_token = null) : RequestInterface
    {
     ...
     *
     * @param int|null $max_results_per_page  The maximum number of results to return per page. If the response exceeds the maximum number of transactions or 10 MB, the response is &#x60;InvalidInput&#x60;. (optional, default to 100)
