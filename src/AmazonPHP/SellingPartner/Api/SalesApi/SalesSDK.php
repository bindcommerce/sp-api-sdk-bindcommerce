...
final class SalesSDK implements SalesSDKInterface
{
     ...
     * @param string|null $amazon_program  Filters the results by the Amazon program that you specify. Do not include this filter if you want the response to include order metrics for all programs. **Example:** &#x60;AmazonHaul&#x60; returns order metrics for the Amazon Haul program only. (optional)
     *
     * @throws ApiException on non-2xx response
     * @throws InvalidArgumentException
     * @return \AmazonPHP\SellingPartner\Model\Sales\GetOrderMetricsResponse
     */
    public function getOrderMetrics(AccessToken $accessToken, string $region, $marketplace_ids, $interval, $granularity, $granularity_time_zone = null, $buyer_type = 'All', $fulfillment_network = null, $first_day_of_week = 'Monday', $asin = null, $sku = null, $amazon_program = null)
    {
        $request = $this->getOrderMetricsRequest($accessToken, $region, $marketplace_ids, $interval, $granularity, $granularity_time_zone, $buyer_type, $fulfillment_network, $first_day_of_week, $asin, $sku, $amazon_program);
     ...
     */
    public function getOrderMetricsRequest(AccessToken $accessToken, string $region, $marketplace_ids, $interval, $granularity, $granularity_time_zone = null, $buyer_type = 'All', $fulfillment_network = null, $first_day_of_week = 'Monday', $asin = null, $sku = null, $amazon_program = null) : RequestInterface
    {
        ...
        // query params
        if (is_array($amazon_program)) {
            $amazon_program = ObjectSerializer::serializeCollection($amazon_program, '', true);
        }
        if ($amazon_program !== null) {
            $queryParams['amazonProgram'] = ObjectSerializer::toString($amazon_program);
        }
