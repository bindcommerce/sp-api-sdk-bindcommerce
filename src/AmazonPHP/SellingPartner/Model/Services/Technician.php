 ...
 */
class Technician implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    {
        if (!is_null($this->container['technician_id']) && (mb_strlen((string) $this->container['technician_id']) > 50)) {
            throw new AssertionException("invalid value for 'technician_id', the character length must be smaller than or equal to 50.");
        }

        if (!is_null($this->container['technician_id']) && (mb_strlen((string) $this->container['technician_id']) < 1)) {
