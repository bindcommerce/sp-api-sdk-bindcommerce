 ...
 */
class Seller implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    {
        if (!is_null($this->container['seller_id']) && !preg_match("/^[A-Z0-9]*$/", (string) $this->container['seller_id'])) {
