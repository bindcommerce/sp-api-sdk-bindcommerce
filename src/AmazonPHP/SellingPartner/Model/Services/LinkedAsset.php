...
class LinkedAsset implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets asset_type
     *
     * @param string|null $asset_type The type of the linked asset. For example: `VEHICLE`.
     *
     * @return self
     */
    public function setAssetType($asset_type) : self
    {
     ...
     * Sets asset_name
     *
     * @param string|null $asset_name The name of the linked asset. For example: `2024 Polaris Slingshot SLR AutoDrive`.
     *
     * @return self
     */
    public function setAssetName($asset_name) : self
    {
     ...
     *
     * @param array<string,string>|null $additional_attributes Additional attributes of the linked asset, such as vehicle make, model, year, and engine details.
     *
     * @return self
     */
    public function setAdditionalAttributes($additional_attributes) : self
    {
