...
class FinancialEvents implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     *
     * @return null|EBTRefundReimbursementOnlyEvent[]
     */
     ...
     *
     * @param null|EBTRefundReimbursementOnlyEvent[] $ebt_refund_reimbursement_only_event_list a list of EBT refund reimbursement events
     */
     ...
     *
     * @param null|SolutionProviderCreditEvent[] $service_provider_credit_event_list a list of `SolutionProviderCreditEvent`
     */
     ...
     *
     * @param null|SAFETReimbursementEvent[] $safet_reimbursement_event_list a list of `SAFETReimbursementEvent`
     */
     ...
     *
     * @param null|RemovalShipmentAdjustmentEvent[] $removal_shipment_adjustment_event_list a comma-delimited list of `RemovalShipmentAdjustment` details for FBA inventory
     */
     ...
     *
     * @param null|TaxWithholdingEvent[] $tax_withholding_event_list a list of tax withholding events
     */
     ...
     *
     * @param null|FailedAdhocDisbursementEvent[] $failed_adhoc_disbursement_event_list a list of `FailedAdhocDisbursementEvent`
     */
