...
class RemovalShipmentAdjustmentEvent implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     *
     * @param null|RemovalShipmentItemAdjustment[] $removal_shipment_item_adjustment_list a comma-delimited list of `RemovalShipmentItemAdjustment` details for FBA inventory
     */
