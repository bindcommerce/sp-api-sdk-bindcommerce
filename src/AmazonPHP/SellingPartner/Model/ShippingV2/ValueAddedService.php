 ...
 */
class ValueAddedService implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     * Sets cost
     *
     * @param \AmazonPHP\SellingPartner\Model\ShippingV2\Currency $cost cost
     */
