 ...
 */
class NdrRequestData implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    {
        if (!is_null($this->container['additional_address_notes']) && (mb_strlen((string) $this->container['additional_address_notes']) > 256)) {
     ...
     *
     * @param \DateTimeInterface|null $reschedule_date The date on which the Seller wants to reschedule shipment delivery, in ISO-8601 date/time format
     */
    public function setRescheduleDate($reschedule_date) : self
    {
     ...
     */
    public function setAdditionalAddressNotes($additional_address_notes) : self
    {
