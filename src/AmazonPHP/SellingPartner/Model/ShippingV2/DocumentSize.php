 ...
 */
class DocumentSize implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    final public const DISCRIMINATOR = null;

    final public const UNIT_INCH = 'INCH';

    final public const UNIT_CENTIMETER = 'CENTIMETER';
