 ...
 */
class DirectPurchaseResult implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'shipment_id' => 'string',
        'package_document_detail_list' => '\AmazonPHP\SellingPartner\Model\ShippingV2\PackageDocumentDetail[]',
    ];
     ...
     *
     * @return null|\AmazonPHP\SellingPartner\Model\ShippingV2\PackageDocumentDetail[]
     */
     ...
     *
     * @param null|\AmazonPHP\SellingPartner\Model\ShippingV2\PackageDocumentDetail[] $package_document_detail_list a list of post-purchase details about a package that will be shipped using a shipping service
     */
