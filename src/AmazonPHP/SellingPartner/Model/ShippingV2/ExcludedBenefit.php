 ...
 */
class ExcludedBenefit implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
    ...
    public function validate() : void
    {
        ...
        if (!is_null($this->container['reason_codes']) && (count($this->container['reason_codes']) < 1)) {
            throw new AssertionException("invalid value for 'reason_codes', number of items must be greater than or equal to 1.");
        }
     ...
     * Sets reason_codes
     *
     * @param string[]|null $reason_codes List of reasons (eg. LATE_DELIVERY_RISK, etc.) indicating why a benefit is excluded for a shipping offer.
     */
