...
class ChargeComponent implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    final public const CHARGE_TYPE_TAX = 'TAX';

    final public const CHARGE_TYPE_DISCOUNT = 'DISCOUNT';
    ...
    public function validate() : void
    {
        ...
        if (null !== $this->container['charge_type'] && !\in_array($this->container['charge_type'], $allowedValues, true)) {
