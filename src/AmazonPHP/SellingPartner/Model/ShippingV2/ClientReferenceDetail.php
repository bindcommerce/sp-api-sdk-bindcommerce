 ...
 */
class ClientReferenceDetail implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    final public const DISCRIMINATOR = null;

    final public const CLIENT_REFERENCE_TYPE_INTEGRATOR_SHIPPER_ID = 'IntegratorShipperId';

    final public const CLIENT_REFERENCE_TYPE_INTEGRATOR_MERCHANT_ID = 'IntegratorMerchantId';
    ...
    public function validate() : void
    {
        ...
        if (null !== $this->container['client_reference_type'] && !\in_array($this->container['client_reference_type'], $allowedValues, true)) {
