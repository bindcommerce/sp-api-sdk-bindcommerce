 ...
 */
class CreateClaimRequest implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * Gets claim_reason.
     */
    public function getClaimReason() : ClaimReason
    {
     ...
     */
    public function setClaimReason(ClaimReason $claim_reason) : self
    {
     ...
     */
    public function setSettlementType(SettlementType $settlement_type) : self
    {
