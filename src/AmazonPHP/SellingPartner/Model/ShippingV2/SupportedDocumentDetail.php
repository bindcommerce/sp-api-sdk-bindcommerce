 ...
 */
class SupportedDocumentDetail implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'name' => '\AmazonPHP\SellingPartner\Model\ShippingV2\DocumentType',
        'is_mandatory' => 'bool',
    ];
     ...
     * Gets name.
     */
    public function getName() : DocumentType
    {
     ...
     */
    public function setName(DocumentType $name) : self
    {
