 ...
 */
class RateItem implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * @return RateItemID
     */
    public function getRateItemId() : RateItemID
    {
     ...
     * Sets rate_item_id.
     *
     * @param RateItemID $rate_item_id rate_item_id
     */
    public function setRateItemId(RateItemID $rate_item_id) : self
    {
     ...
     */
    public function getRateItemType() : ?RateItemType
    {
     ...
     */
    public function setRateItemType(?RateItemType $rate_item_type) : self
    {
