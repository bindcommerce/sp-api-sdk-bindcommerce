 ...
 */
class CustomerInvoiceList implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     *
     * @param \AmazonPHP\SellingPartner\Model\VendorDirectFulfillmentShipping\CustomerInvoice[]|null $customer_invoices Represents a customer invoice within the `CustomerInvoiceList`.
     */
