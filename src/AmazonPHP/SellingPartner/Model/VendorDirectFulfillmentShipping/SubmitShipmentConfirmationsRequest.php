 ...
 */
class SubmitShipmentConfirmationsRequest implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     *
     * @param \AmazonPHP\SellingPartner\Model\VendorDirectFulfillmentShipping\ShipmentConfirmation[]|null $shipment_confirmations Array of `ShipmentConfirmation` objects. Each `ShipmentConfirmation` object represents the confirmation details for a specific shipment.
     */
