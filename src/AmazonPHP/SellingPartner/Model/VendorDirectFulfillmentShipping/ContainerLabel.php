 ...
 */
class ContainerLabel implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     */
    public function setContainerTrackingNumber($container_tracking_number) : self
    {
     ...
     * Gets format
     *
     * @return \AmazonPHP\SellingPartner\Model\VendorDirectFulfillmentShipping\ContainerLabelFormat
     */
