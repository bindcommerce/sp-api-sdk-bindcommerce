 ...
 */
class ItemProceedsDetailedBreakdown implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'subtype' => 'string',
        'value' => '\AmazonPHP\SellingPartner\Model\OrdersV2026\Money',
    ];
