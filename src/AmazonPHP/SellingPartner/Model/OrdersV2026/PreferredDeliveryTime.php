...
class PreferredDeliveryTime implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * Sets business_hours.
     *
     * @param null|BusinessHour[] $business_hours business hours when the business is open for deliveries
     */
     ...
     *
     * @param null|ExceptionDate[] $exception_dates specific dates within the next 30 days when normal business hours do not apply
     */
