 ...
 */
class ItemPromotion implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * Gets breakdowns.
     *
     * @return null|ItemPromotionBreakdown[]
     */
     ...
     * Sets breakdowns.
     *
     * @param null|ItemPromotionBreakdown[] $breakdowns a list of promotions applied to the order item
     */
