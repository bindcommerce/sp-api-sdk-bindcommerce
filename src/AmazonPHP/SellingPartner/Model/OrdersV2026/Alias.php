 ...
 */
class Alias implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    public function validate() : void
    {
        if ($this->container['alias_id'] === null) {
            throw new AssertionException("'alias_id' can't be null");
        }

        if ($this->container['alias_type'] === null) {
            throw new AssertionException("'alias_type' can't be null");
        }
    }
