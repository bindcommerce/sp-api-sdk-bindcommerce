 ...
 */
class BusinessHour implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     * Sets time_windows.
     *
     * @param null|TimeWindow[] $time_windows collection of time windows during which the location is available for deliveries on the specified day
     */
