 ...
 */
class DeliveryPreference implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        ...
        'delivery_time' => '\AmazonPHP\SellingPartner\Model\OrdersV2026\PreferredDeliveryTime',
    ...
    public function validate() : void
    {
        if ($this->container['delivery_time'] !== null) {
            $this->container['delivery_time']->validate();
        }
    }
     ...
     *
     * @param null|string[] $delivery_capabilities a list of miscellaneous delivery capabilities associated with the shipping address
     */
