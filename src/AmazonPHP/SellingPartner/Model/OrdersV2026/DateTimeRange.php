 ...
 */
class DateTimeRange implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
    ...
    protected static array $openAPITypes = [
        'earliest_date_time' => '\DateTimeInterface',
        'latest_date_time' => '\DateTimeInterface',
    ];
     ...
     */
    public function getEarliestDateTime() : ?\DateTimeInterface
    {
     ...
     *
     * @param null|\DateTimeInterface $earliest_date_time The beginning of the time period, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format.
     */
    public function setEarliestDateTime(?\DateTimeInterface $earliest_date_time) : self
    {
     ...
     *
     * @param null|\DateTimeInterface $latest_date_time The end of the time period, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format.
     */
    public function setLatestDateTime(?\DateTimeInterface $latest_date_time) : self
    {
