...
class DateTimeRange implements ModelInterface, ArrayAccess, \JsonSerializable, \Stringable
{
     ...
     *
     * @param \DateTimeInterface|null $earliest_date_time The beginning of the time period, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format.
     */
     ...
     *
     * @param \DateTimeInterface|null $latest_date_time The end of the time period, in [ISO 8601](https://developer-docs.amazon.com/sp-api/docs/iso-8601) format.
     */
