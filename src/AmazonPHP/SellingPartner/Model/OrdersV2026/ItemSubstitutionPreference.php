 ...
 */
class ItemSubstitutionPreference implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     *
     * @return null|ItemSubstitutionOption[]
     */
     ...
     *
     * @param null|ItemSubstitutionOption[] $substitution_options list of alternative products that can be substituted for the original item if it becomes unavailable
     */
