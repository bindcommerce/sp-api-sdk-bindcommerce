 ...
 */
class PackageItem implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     *
     * @param null|string[] $transparency_codes the transparency codes associated with this item for product authentication
     */
