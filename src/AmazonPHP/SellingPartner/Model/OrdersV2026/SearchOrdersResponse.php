 ...
 */
class SearchOrdersResponse implements \ArrayAccess, \JsonSerializable, \Stringable, ModelInterface
{
     ...
     */
    public function getLastUpdatedBefore() : ?\DateTimeInterface
    {
     ...
     *
     * @param null|\DateTimeInterface $last_updated_before Only orders updated before the specified time are returned. The date must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.
     */
    public function setLastUpdatedBefore(?\DateTimeInterface $last_updated_before) : self
    {
     ...
     * Sets created_before.
     *
     * @param null|\DateTimeInterface $created_before Only orders placed before the specified time are returned. The date must be in <a href='https://developer-docs.amazon.com/sp-api/docs/iso-8601'>ISO 8601</a> format.
     */
    public function setCreatedBefore(?\DateTimeInterface $created_before) : self
    {
